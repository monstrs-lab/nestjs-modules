  ...
  static register(options: BullConfigOptions = {}): DynamicModule {
    return {
      ...
      providers: [
        ...
        {
          provide: BULL_CONFIG_MODULE_OPTIONS_REDIS_USERNAME,
          useValue: options.redis?.username,
        },
        {
          provide: BULL_CONFIG_MODULE_OPTIONS_REDIS_PASSWORD,
          useValue: options.redis?.password,
        },
      ],
